	...
	<form action="/item2/modify" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name ="pictureUrl2" value="${item.pictureUrl2 }">
			...
			<tr>
				<td>파일</td>
				<td>
					<img src ="/item2/display?itemId=${item.itemId }" width="400" height="300" alt="${item.pictureUrl }"/>
				</td>
			</tr>
			<tr>
				<td> 파일</td>
			...
			<tr>
				<td>파일</td>
				<td>
					<img src ="/item2/display2?itemId=${item.itemId }" width="400" height="300" alt="${item.pictureUrl2 }"/>
				</td>
			</tr>
			<tr>
				<td> 파일</td>
