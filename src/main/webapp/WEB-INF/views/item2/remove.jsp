	...
	<form action="/item2/remove" method="post">
		<input type="hidden" name ="itemId" value="${item.itemId }">
			...
			<tr>
				<td>파일</td>
				<td>
					<img src ="/item2/display?itemId=${item.itemId }" width="250" height="300" alt="${item.pictureUrl }"/>
				</td>
			</tr>
			<tr>
				<td>파일</td>
				<td>
					<img src ="/item2/display2?itemId=${item.itemId }" width="250" height="300" alt="${item.pictureUrl2 }"/>
				</td>
			</tr>
			<tr>
				<td> 개요</td>
